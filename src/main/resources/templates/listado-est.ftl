...
<div>
  <a href="/" class="btn btn-link btn-outline-primary"style="margin-top:20px; margin-bottom:20px">Registar Nuevo Estudiante</a>
</div>
  ...
  <tr>
    ...
    <th>
      ...
      <div class="text-center">
        <button id-stu="${estu.id}" id="edit" class="btn btn-block btn-secondary" data-toggle="modal" data-target="#modalLoginForm">Edit</button>
      </div>
    </th>
    <th>
